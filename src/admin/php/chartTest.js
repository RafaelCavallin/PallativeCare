...
var data = [90, 90, 80, 60, 40, 50, 30, 20, 0];
var paciente = 'Marcos Oliveira';
var targetId = 'testAreaChart';

createChart(labels, data, paciente, targetId);

function createChart(labels, data, paciente, targetId){
